...
obj/fringe_search_13.o: src/fringe_search.cpp src/fringe_search.h src/constants.h
	cd src; gcc fringe_search.cpp -o ../obj/fringe_search_13.o

obj/fringe_13.o: src/fringe.cpp src/fringe.h src/constants.h
	cd src; gcc fringe.cpp -o ../obj/fringe_13.o
